...
-->
This project examines public support for gender-affirming care. Given the increase in media coverage and the spread of misinformation about transgender healthcare, we saw a need to conduct a study to see if the perceived credibility of information about transgender people impacts individual actions regarding support of legislative regulations for gender affirming healthcare? We developed three hypotheses to guide this study. H1: Exposure to factual information presented by a credible source will have a negative impact on the support for legislation banning gender-affirming care options. H2: Exposure to factual information presented alongside a statistic will have a negative impact on the support for legislation banning gender-affirming care options. H3: Participants may have prior experience with the topic of gender-affirming care before exposure to experimental treatments. Prior misconceptions about medical transition among youth will likely lead to higher support for bans. Vice-versa, participants with no prior misconceptions will likely have higher congruence with credible trans-affirming information. The methodology, analysis, and results of our study are described in the succeeding sections.
...
Our results were a little surprising. The lack of diffuse support for transgender affirming care, as judged by the responses, should be further investigated. We did not see a need to include political parties or race in the analytical model. People identifying as Democratic or liberal were overrepresented in this survey. Race was not a necessary variable for the purposes of this analysis. Geographic region and age, however, were deemed appropriate metrics for the purposes of our data analysis.

We did see limitations of our study. The double-negative in our main outcome question is a primary limitation. We also did not have any way to isolate the effects between the manipulation check and the outcome variables. We, furthermore, were surprised by the plurality of Democratic or liberal respondents in this survey. We believe that a more diverse pool of participants might have enhanced the response data we collected. 
